    ...
    <body class="ff-sans fs1-6 sm-fs3-2 c-blue">
      ...
      <main class="p1">
        <header class="lg-psf lg-t0 lg-pt1">
          ...
          <h2 class="c-pink"><button class="${state.label == 'Pause' ? 'blink': ''}" onclick=${toggle}>${state.label}</button>, <a href="/files/Bloom_Filter-9_1_18.mp3" download="Bloom Filter 9-1-18">Download</a>, <a href="https://soundcloud.com/bloomfilter/9118-partners-new-haven-live"  target="_blank" rel="noopener noreferrer">Soundcloud</a></h2>
        </header>
